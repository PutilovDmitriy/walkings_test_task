...
function WalkingContent( props ) {    
    return (
     <Tr bgColor={ props.bgColor }>
        <Th marginLeft="16px"><WalkingDate date={ props.walking.date } fontSizeDate="12px"/></Th>
        <Th minWidth="143px"><Distance maxWidth="143px" distance={ props.walking.distance } fontSize="12px"/></Th>
