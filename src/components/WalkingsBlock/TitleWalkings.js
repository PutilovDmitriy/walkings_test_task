...
function TitleWalkings() {
    ...
    return(
      <Thead>
        <Tr bgColor="#1C2025">
            <Th marginLeft="16px" margin="13px 0">
            <P onClick={ sortByDate } display="inline-block" fontSize="14px" color="#FFFFFF">Дата</P>
            <ImgSort src={ SortImg } transform={sortDate} opacity={sortDate} alt=""/>
            </Th>
            <Th margin="13px 0">
            <P onClick={ sortByDistance } display="inline-block" fontSize="14px" color="#FFFFFF">Дистанция</P>
